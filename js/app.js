(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".thumbs-product__slider")) {
            const thumbsSwiper = new core(".thumbs-product__slider", {
            ...
            new core(".imadge-product__slider", {
                modules: [ Thumb, Navigation, Pagination, EffectFade ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                autoHeight: true,
...
***************************************************************************** */
    ...
    let goodsCloses = document.querySelectorAll(".goods__close");
    goodsCloses.forEach((goodsClose => {
        goodsClose.addEventListener("click", (function(e) {
            const blockParent = goodsClose.parentElement;
            blockParent.remove();
        }));
    }));
